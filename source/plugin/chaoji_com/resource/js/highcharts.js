...
(function () {
    ...
    Ka = M.map, J = M.addEvent, ba = M.removeEvent, D = M.fireEvent, Pb = M.washMouseEvent, vb = M.animate, Ta = M.stop, M = { enabled: !0, align: "center", x: 0, y: 15, style: { color: "#666", cursor: "default", fontSize: "11px", lineHeight: "14px"} };
        N = { colors: "#4572A7,#AA4643,#89A54E,#80699B,#3D96AE,#DB843D,#92A8CD,#A47D7C,#B5CA92".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: { loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","),
        ...
        }, global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/3.0.1/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/3.0.1/gfx/vml-radial-gradient.png" }, chart: { borderColor: "#4572A7", borderRadius: 5,
        ...
        ab.prototype = { defaultOptions: { dateTimeLabelFormats: { millisecond: "%H:%M:%S.%L",
        ...
        }, defaultLeftAxisOptions: { labels: { align: "right", x: -8, y: null }, title: { rotation: 270} }, defaultRightAxisOptions: { labels: { align: "left", x: 8, y: null }, title: { rotation: 90} },
            ...
            i = b.itemStyle, j = b.itemHiddenStyle, k = b.padding, m = !e.rtl, l = e.width, p = e.itemMarginBottom || 0, s = b.itemMarginTop, o = b.initialItemX, n = a.legendItem, t = a.series || a, r = t.options, v = r.showCheckbox, u = e.useHTML;
                                var m_options = b.options;
                                var allitems = b.allItems;
            ...
            function () {
                ...
                var c = function () {
                    a.setVisible(undefined, undefined, function () {
                        if (m_options != undefined && typeof m_options.legendItemClick == 'function') {
                            m_options.legendItemClick(allitems, a);
                        }
                    })
                }, b = { browserEvent: b };
        ...
        b, c, d) {
            ...
            a = a || "";
                                    ...
                                    }, setVisible: function (a, b, m_callback) {

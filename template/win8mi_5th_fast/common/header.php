 ...
 <div class="wp">
  ...
  <div class="userbox"> 
    ...
    <ul class="usernav">
      ...
      <li class="user_list"><!--{hook/global_usernav_extra1}--></li>
      <li class="user_list"><!--{hook/global_usernav_extra2}--></li>
      <li class="user_list"><!--{hook/global_usernav_extra3}--></li>   
   </ul>
    ...
    <ul class="usernav user_part">
	  <li class="user_list"><!--{hook/global_login_extra}--></li>

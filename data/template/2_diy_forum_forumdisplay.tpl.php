...
0
|| checktplrefresh('./template/win8mi_5th_fast/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1419825284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/win8mi_5th_fast', 'forum/forumdisplay')
|| checktplrefresh('./template/win8mi_5th_fast/forum/forumdisplay.htm', './template/win8mi_5th_fast/forum/recommend.htm', 1419825284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/win8mi_5th_fast', 'forum/forumdisplay')
|| checktplrefresh('./template/win8mi_5th_fast/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1419825284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/win8mi_5th_fast', 'forum/forumdisplay')
|| checktplrefresh('./template/win8mi_5th_fast/forum/forumdisplay.htm', './template/win8mi_5th_fast/forum/forumdisplay_list.htm', 1419825284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/win8mi_5th_fast', 'forum/forumdisplay')
|| checktplrefresh('./template/win8mi_5th_fast/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1419825284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/win8mi_5th_fast', 'forum/forumdisplay')
|| checktplrefresh('./template/win8mi_5th_fast/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1419825284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/win8mi_5th_fast', 'forum/forumdisplay')
|| checktplrefresh('./template/win8mi_5th_fast/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1419825284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/win8mi_5th_fast', 'forum/forumdisplay')
...
<?php if($_G['forum']['banner'] && !$subforumonly) { ?><img src="<?php echo $_G['forum']['banner'];?>" alt="<?php echo $_G['forum']['name'];?>" style="width: 100%; margin-bottom: 5px;" /><?php } ?>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" style="font-size: 16px; font-family: 'Microsoft Yahei'; color: #35B5EB;"><?php echo $_G['forum']['name'];?></a>
...
<?php } ?> 
  ...
  <div class="th menubox cl">
    <th colspan="<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>3<?php } else { ?>2<?php } ?>"> <?php if(CURMODULE != 'guide') { ?>
      
      <div class="y"> <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=lastpost&amp;orderby=lastpost<?php echo $forumdisplayadd['lastpost'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'lastpost') { ?> xw1<?php } ?>">最新</a>&nbsp; <span class="pipe">|</span> <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=heat&amp;orderby=heats<?php echo $forumdisplayadd['heat'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'heat') { ?> xw1<?php } ?>">热门</a>&nbsp; <span class="pipe">|</span> <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="xi2<?php if($_GET['filter'] == 'hot') { ?> xw1<?php } ?>">热帖</a>&nbsp; <span class="pipe">|</span> <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=digest&amp;digest=1<?php echo $forumdisplayadd['digest'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'digest') { ?> xw1<?php } ?>">精华</a>&nbsp; <span class="pipe">|</span> 
        ...
        <?php } ?> 
        <span id="atarget" <?php if($_G['cookie']['atarget'] > 0) { ?>onclick="setatarget(-1)" class="atarget_1" <?php } else { ?>onclick="setatarget(1)" <?php } ?> title="在新窗口中打开帖子">新窗</span> </div>
      筛选： 
      ...
      <span><?php echo $ctime;?></span> <img src="<?php echo IMGDIR;?>/date_magnify.png" class="cur1" alt="" id="hottime" value="<?php echo $ctime;?>" fid="<?php echo $_G['fid'];?>" onclick="showcalendar(event, this, false, false, false, false, function(){viewhot(this);});" align="absmiddle" /> 
      <?php } ?> 
      ...
      <table summary="forum_<?php echo $_G['fid'];?>" cellspacing="0" cellpadding="0" id="threadlisttableid">
        ...
        <tbody>
          <tr>
            ...
            <td class="by"><cite><a href="home.php?mod=space&amp;uid=<?php echo $announcement['authorid'];?>" c="1"><?php echo $announcement['author'];?></a></cite> <em><?php echo $announcement['starttime'];?></em></td>
            <td class="num">&nbsp;</td>
            <td class="by">&nbsp;</td>
          </tr>
        </tbody>
        ...
        <?php if(empty($_G['forum']['picstyle']) || $_G['cookie']['forumdefstyle']) { ?> 
        <?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { ?> 
        ...
        <td class="icon"><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" class="arvtx" c="1"><?php echo avatar($thread[authorid],small);?></a></td>
          <td class="icn"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['icontid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>" title="<?php if($thread['displayorder'] == 1) { ?>本版置顶主题 - <?php } if($thread['displayorder'] == 2) { ?>分类置顶主题 - <?php } if($thread['displayorder'] == 3) { ?>全局置顶主题 - <?php } if($thread['displayorder'] == 4) { ?>多版置顶主题 - <?php } if($thread['folder'] == 'lock') { ?>关闭的主题 - <?php } if($thread['special'] == 1) { ?>投票 - <?php } if($thread['special'] == 2) { ?>商品 - <?php } if($thread['special'] == 3) { ?>悬赏 - <?php } if($thread['special'] == 4) { ?>活动 - <?php } if($thread['special'] == 5) { ?>辩论 - <?php } if($thread['folder'] == "new") { ?>有新回复 - <?php } ?>
新窗口打开" target="_blank"> 
            <?php if($thread['folder'] == 'lock') { ?> 
            <img src="<?php echo $_G['style']['styleimgdir'];?>/common/folder_lock.gif" /> 
            <?php } elseif($thread['special'] == 1) { ?> 
            <img src="<?php echo $_G['style']['styleimgdir'];?>/common/pollsmall.gif" alt="投票" /> 
            <?php } elseif($thread['special'] == 2) { ?> 
            <img src="<?php echo $_G['style']['styleimgdir'];?>/common/tradesmall.gif" alt="商品" /> 
            <?php } elseif($thread['special'] == 3) { ?> 
            <img src="<?php echo $_G['style']['styleimgdir'];?>/common/rewardsmall.gif" alt="悬赏" /> 
            <?php } elseif($thread['special'] == 4) { ?> 
            <img src="<?php echo $_G['style']['styleimgdir'];?>/common/activitysmall.gif" alt="活动" /> 
            <?php } elseif($thread['special'] == 5) { ?> 
            <img src="<?php echo $_G['style']['styleimgdir'];?>/common/debatesmall.gif" alt="辩论" /> 
            ...
            <?php } else { ?> 
            <img src="<?php echo $_G['style']['styleimgdir'];?>/common/folder_<?php echo $thread['folder'];?>.gif" /> 
            <?php } ?> 
            </a></td>
          <?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
          <td class="o"><?php if($thread['fid'] == $_G['fid']) { ?> 
            ...
            <?php } ?></td>
          <?php } ?>
          <th class="<?php echo $thread['folder'];?>"> <a href="javascript:;" id="content_<?php echo $thread['tid'];?>" class="showcontent y" title="更多操作" onclick="CONTENT_TID='<?php echo $thread['tid'];?>';CONTENT_ID='<?php echo $thread['id'];?>';showMenu({'ctrlid':this.id,'menuid':'content_menu'})"></a> 
            ...
            <?php if(!(!empty($_G['setting']['antitheft']['allow']) && empty($_G['setting']['antitheft']['disable']['thread']) && empty($_G['forum']['noantitheft']))) { ?> 
            ...
            <?php if($_G['setting']['threadhidethreshold'] && $thread['hidden'] >= $_G['setting']['threadhidethreshold']) { ?><span class="xg1">隐藏</span>&nbsp;<?php } ?> 
          ...
          <?php } ?>
          <td class="by"><?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_author'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_author'][$key];?> 
            <cite> 
            ...
            <?php } ?> 
            </cite> <em><span<?php if($thread['istoday']) { ?> class="xi1"<?php } ?>><?php echo $thread['dateline'];?></span></em></td>
          <td class="num"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" class="xi2"><?php echo $thread['allreplies'];?></a> <span class="line">/</span> <em><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></em></td>
          <td class="by"><cite><?php if($thread['lastposter']) { ?><a href="<?php if($thread['digest'] != -2) { ?>home.php?mod=space&username=<?php echo $thread['lastposterenc'];?><?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?>&page=<?php echo max(1, $thread['pages']);; } ?>" c="1"><?php echo $thread['lastposter'];?></a><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?></cite> <em><a href="<?php if($thread['digest'] != -2 && !$thread['ordertype']) { ?>forum.php?mod=redirect&tid=<?php echo $thread['tid'];?>&goto=lastpost<?php echo $highlight;?>#lastpost<?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?><?php if(!$thread['ordertype']) { ?>&page=<?php echo max(1, $thread['pages']);; } } ?>"><?php echo $thread['lastpost'];?></a></em></td>
        </tr>
          </tbody>
      ...
      <ul id="waterfall" class="ml waterfall cl">
        <?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { ?> 
        <?php if($_G['hiddenexists'] && $thread['hidden']) { ?> 
        <?php continue;?> 
        <?php } ?> 
        <?php if(!$thread['forumstick'] && ($thread['isgroup'] == 1 || $thread['fid'] != $_G['fid'])) { ?> 
        <?php if($thread['related_group'] == 0 && $thread['closed'] > 1) { ?> 
        ...
        <?php } ?> 
        <?php } ?> 
        <?php $waterfallwidth = $_G[setting][forumpicstyle][thumbwidth] + 24;?>        <li style="width: <?php echo $_G['setting']['forumpicstyle']['thumbwidth'];?>px" class="cl"> 
          <?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
          ...
          <?php } ?>
          <div class="c cl"> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>" <?php if($thread['isgroup'] == 1 || $thread['forumstick'] || CURMODULE == 'guide') { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> title="<?php echo $thread['subject'];?>" class="z"> 
            <?php if($thread['cover']) { ?> 
          ...
          <h3 class="xw0"> 
            <?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_thread'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_thread'][$key];?> 
            <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>"<?php echo $thread['highlight'];?><?php if($thread['isgroup'] == 1 || $thread['forumstick']) { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> title="<?php echo $thread['subject'];?>"><?php echo $thread['subject'];?></a> </h3>
          <div class="auth cl"> <cite class="xg1 y">
            <div class="love"><?php if($thread['recommends']) { ?><?php echo $thread['recommends'];?><?php } else { ?>0<?php } ?></div>
            <div class="reply"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" title="<?php echo $thread['replies'];?> 回复"><?php echo $thread['replies'];?></a></div>
            </cite> 
            <?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_author'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_author'][$key];?> 
            <?php if($thread['authorid'] && $thread['author']) { ?> 
            <a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" class="arvtx" c="1"><?php echo avatar($thread[authorid],small);?></a><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" style="float: left; padding-left: 8px; color: #999999;"><?php echo $thread['author'];?></a><?php if(!empty($verify[$thread['authorid']])) { ?> <?php echo $verify[$thread['authorid']];?><?php } ?> 
            <?php } else { ?> 
            <?php echo $_G['setting']['anonymoustext'];?> 
            <?php } ?> 
          </div>
...
<?php } ?>
      ...
      <tbody class="bw0_all">
        <tr>
          <th colspan="<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>6<?php } else { ?>5<?php } ?>"><p class="emp">本版块或指定的范围内尚无主题</p></th>
        </tr>
      </tbody>
      </table>
      ...
      <?php include template('forum/topicadmin_modlayer'); ?> 
      <?php } ?>
    </form>
  </div>
  ...
  <?php } ?> 
  <?php } ?>
  <div class="bw0 pgs cl" style="padding: 10px 20px 30px 20px"> <span id="fd_page_bottom"><?php echo $multipage;?></span> <span <?php if($_G['setting']['visitedforums']) { ?>id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?> class="pgb y"><a href="forum.php">返&nbsp;回</a></span> 
...
<div id="filter_special_menu" class="p_pop" style="display:none" change="location.href='forum.php?mod=forumdisplay&fid=<?php echo $_G['fid'];?>&filter='+$('filter_special').value">
  <ul>
    ...
    <?php if($showpoll) { ?>
    <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=poll<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">投票</a></li>
    <?php } ?> 
    <?php if($showtrade) { ?>
    <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=trade<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">商品</a></li>
    <?php } ?> 
    <?php if($showreward) { ?>
    <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">悬赏</a></li>
    <?php } ?> 
    <?php if($showactivity) { ?>
    <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=activity<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">活动</a></li>
    <?php } ?> 
    <?php if($showdebate) { ?>
    <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=debate<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">辩论</a></li>
    <?php } ?>
  </ul>
</div>
<div id="filter_reward_menu" class="p_pop" style="display:none" change="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype='+$('filter_reward').value">
  <ul>
    ...
    <?php if($showpoll) { ?>
    <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype=1">进行中</a></li>
    <?php } ?> 
    <?php if($showtrade) { ?>
    <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype=2">已解决</a></li>
    <?php } ?>
  </ul>
</div>
<div id="filter_dateline_menu" class="p_pop" style="display:none">
  <ul>
    <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;filter=dateline<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if(!$_GET['dateline']) { ?> <?php } ?>>全部时间</a></li>
...
<h2 style="font-size: 14px;">所属分类: <?php echo cutstr($_G['cache']['forums'][$_G['forum']['fup']]['name'], 22, '')?></h2>
</div>
...
<li style="margin: 0 0 6px 0; height: 22px; line-height: 22px;"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $bforum['fid'];?>" style="display: block; width: 83px; height: 22px; line-height: 22px; text-align: center; padding: 0; color: #FFFFFF; overflow: hidden; background: #35B5EB;"><?php echo $bforum['name'];?></a></li>
<?php } } ?>
</ul>
</div>
</div>
...
<h2 style="font-size: 14px;">推荐<?php echo $_G['setting']['navs']['3']['navname'];?></h2>
</div>
...
<h2 style="font-size: 14px;">正在浏览此版块的会员 (<?php echo $onlinenum;?>)</h2>
</div>

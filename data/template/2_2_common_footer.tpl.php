...
<div id="footer" class="cl">
 ...
 <?php if($_G['setting']['site_qq']) { ?><a href="http://wpa.qq.com/msgrd?V=3&amp;uin=<?php echo $_G['setting']['site_qq'];?>&amp;Site=<?php echo $_G['setting']['bbname'];?>&amp;Menu=yes&amp;from=discuz" target="_blank" title="QQ"><img src="<?php echo IMGDIR;?>/site_qq.jpg" alt="QQ" /></a><span class="pipe">|</span><?php } ?>  
  ...
  <a href="#">About us</a><span class="pipe">|</span> <a href="forum.php?mod=misc&amp;action=showdarkroom">小黑屋</a><span class="pipe">|</span> <strong><a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a></strong>
        <?php if(!empty($_G['setting']['pluginhooks']['global_footerlink'])) echo $_G['setting']['pluginhooks']['global_footerlink'];?> 
        <?php if($_G['setting']['statcode']) { ?><?php echo $_G['setting']['statcode'];?><?php } ?> 

      </p>
      <p>官方论坛 <a href="http://www.verytalk.xyz" target="_blank" style="color: #888888;">Verytalk!</a> <em>for Jason</em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <?php } ?> 
        &copy; 2001-2014 <a href="http://www.verytalk.xyz" target="_blank" style="color: #888888;">Verytalk Inc.</a>
<?php if($_G['setting']['icp']) { ?> <a href="http://www.miitbeian.gov.cn/" target="_blank" style="color: #888888;"><?php echo $_G['setting']['icp'];?></a><?php } ?> 

</p>
      <p class="xs0" style="display: none;"> GMT<?php echo $_G['timenow']['offset'];?>, <?php echo $_G['timenow']['time'];?> <span id="debuginfo"> 

...
<script src="template/win8mi_5th_fast/src/js/superslide.2.1.js" type="text/javascript"></script>
...
<?php } ?>
<style type="text/css"> 
#gongao{width:auto;height:30px;overflow:hidden;line-height:30px;font-size:13px;font-family:'宋体';background:#F6F6F6;color:#0C77CF;font-weight:bold;} 
#gongao #scroll_begin, #gongao #scroll_end{display:inline} 
#paddings{padding:3px;}
    h4{color:red; font-weight:900;}
    .y{color:#E2D6C6;}
</style> 
...
<div id="gongao"> 
<div style="width:900px;height:20px;margin:0 auto;white-space: nowrap;overflow:hidden;" id="scroll_div" class="scroll_div"> 
<div id="scroll_begin"> 
 <?php echo $str;?>
</div> 
...
<div class="replaybox">
<h4 style="color:red;font-weight:900;"><span class="tit_replay"></span>Welcome VeryTalk -!</h4>										
<?php echo $imgs;?>
     </div>
</div>
</div>
...
<table cellspacing="0" cellpadding="0" class="fl_tb">
<tr><?php if(is_array($cat['forums'])) foreach($cat['forums'] as $forumid) { $forum=$forumlist[$forumid];?><?php $forum=$rr[$forumid];?><?php $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];?><?php if($cat['forumcolumns']) { if($forum['orderid'] && ($forum['orderid'] % $cat['forumcolumns'] == 0)) { ?>
</tr>

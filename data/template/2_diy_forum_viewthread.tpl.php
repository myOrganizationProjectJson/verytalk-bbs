...
0
|| checktplrefresh('./template/win8mi_5th_fast/forum/viewthread.htm', './template/win8mi_5th_fast/forum/viewthread_node.htm', 1419825381, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/win8mi_5th_fast', 'forum/viewthread')
|| checktplrefresh('./template/win8mi_5th_fast/forum/viewthread.htm', './template/win8mi_5th_fast/forum/viewthread_fastpost.htm', 1419825381, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/win8mi_5th_fast', 'forum/viewthread')
|| checktplrefresh('./template/win8mi_5th_fast/forum/viewthread.htm', './template/win8mi_5th_fast/forum/viewthread_node_body.htm', 1419825381, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/win8mi_5th_fast', 'forum/viewthread')
|| checktplrefresh('./template/win8mi_5th_fast/forum/viewthread.htm', './template/default/common/seditor.htm', 1419825381, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/win8mi_5th_fast', 'forum/viewthread')
|| checktplrefresh('./template/win8mi_5th_fast/forum/viewthread.htm', './template/default/common/seccheck.htm', 1419825381, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/win8mi_5th_fast', 'forum/viewthread')
|| checktplrefresh('./template/win8mi_5th_fast/forum/viewthread.htm', './template/default/common/upload.htm', 1419825381, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/win8mi_5th_fast', 'forum/viewthread')
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=typeid&amp;typeid=<?php echo $_G['forum_thread']['typeid'];?>" style="color: #555555; font-size: 18px; font-weight: 600;">[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]</a>
<?php } else { ?>
[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]
<?php } } if($threadsorts && $_G['forum_thread']['sortid']) { ?>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=sortid&amp;sortid=<?php echo $_G['forum_thread']['sortid'];?>" style="color: #555555; font-size: 18px; font-weight: 600;">[<?php echo $_G['forum']['threadsorts']['types'][$_G['forum_thread']['sortid']];?>]</a>
<?php } ?>
<span id="thread_subject" style="color: #555555; font-size: 18px; font-weight: 600;"><?php echo $_G['forum_thread']['subject'];?></span>
</h1>
...
<div id="post_<?php echo $post['pid'];?>" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none; border-bottom: 1px solid #EEEEEE;"<?php } ?>><?php $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
...
<?php } ?>	
<td class="plc animated fadeInUp"<?php if($close_leftinfo) { ?> style="width:100%"<?php } ?>>
    <i class="arr"></i>
...
<?php if($_G['setting']['authoronleft']) { ?>
                   <a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" <?php if($post['groupcolor']) { ?> style="color: <?php echo $post['groupcolor'];?>;"<?php } ?>><?php echo $post['author'];?></a>
<?php } ?>
...
<em id="authorposton<?php echo $post['pid'];?>" style="padding: 0 0 0 10px;">发表于 <?php echo $post['dateline'];?></em>
